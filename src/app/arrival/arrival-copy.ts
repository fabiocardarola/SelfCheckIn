...
interface ArrivalCopy {
  ...
  ncc: string; startingPrice: string; upToGuests: string; quote: string; luggage: string; port: string; nccInfo: string; nccContact: string; whatsapp: string; close: string; nccMessage: string; unknownDate: string; noQuote: string;
...
export const ARRIVAL_COPY: Record<RegistrationLanguage, ArrivalCopy> = {
  it: {
    ...
    startingPrice: 'Prezzi a partire da {price}', upToGuests: 'Fino a {count} persone',
    ncc: 'Auto privata · NCC', quote: '{price} totali per {count} persone', noQuote: 'Preventivo su richiesta per questo gruppo.',
    luggage: "Bagagli inclusi nel prezzo.", port: "Dal porto di Civitavecchia: {price} totali, bagagli inclusi.", nccInfo: 'Listino Prezzi', nccContact: 'Chiedi al tuo host...', whatsapp: 'Chiedi con whatsapp...', close: "Chiudi", nccMessage: "Sono {name}, prenotazione numero {pnr} con arrivo il {date}. Vorrei maggiori informazioni sul trasferimento con auto privata NCC.", unknownDate: "data da confermare",
  ...
  fr: {
    ...
    startingPrice: 'Prix à partir de {price}', upToGuests: 'Jusqu’à {count} personnes',
    ncc: 'Voiture privée · NCC', quote: '{price} au total pour {count} personnes', noQuote: 'Devis sur demande pour ce groupe.',
    luggage: "Les bagages sont inclus dans le prix.", port: "Depuis le port de Civitavecchia : {price} au total, bagages inclus.", nccInfo: 'Tarifs', nccContact: 'Demandez à votre hôte...', whatsapp: 'Demander sur WhatsApp...', close: "Fermer", nccMessage: "Je suis {name}, réservation numéro {pnr}, avec une arrivée le {date}. Je souhaite plus d’informations sur le transfert en voiture privée NCC.", unknownDate: "date à confirmer",
  ...
  de: {
    ...
    startingPrice: 'Preise ab {price}', upToGuests: 'Bis zu {count} Personen',
    ncc: 'Privatwagen · NCC', quote: '{price} insgesamt für {count} Personen', noQuote: 'Preis für diese Gruppe auf Anfrage.',
    luggage: "Gepäck ist im Preis enthalten.", port: "Ab Hafen Civitavecchia: insgesamt {price}, inklusive Gepäck.", nccInfo: 'Preisliste', nccContact: 'Frage deinen Gastgeber...', whatsapp: 'Über WhatsApp fragen...', close: "Schließen", nccMessage: "Ich bin {name}, Buchungsnummer {pnr}, mit Ankunft am {date}. Ich möchte weitere Informationen zum privaten NCC-Transfer.", unknownDate: "Datum noch zu bestätigen",
  ...
  pt: {
    ...
    startingPrice: 'Preços a partir de {price}', upToGuests: 'Até {count} pessoas',
    ncc: 'Carro privado · NCC', quote: '{price} no total para {count} pessoas', noQuote: 'Orçamento sob consulta para este grupo.',
    luggage: "A bagagem está incluída no preço.", port: "Do porto de Civitavecchia: {price} no total, bagagem incluída.", nccInfo: 'Tabela de preços', nccContact: 'Pergunte ao seu anfitrião...', whatsapp: 'Perguntar pelo WhatsApp...', close: "Fechar", nccMessage: "Sou {name}, reserva número {pnr}, com chegada em {date}. Gostaria de mais informações sobre o transfer em carro privado NCC.", unknownDate: "data a confirmar",
  ...
  ko: {
    ...
    startingPrice: '요금은 {price}부터', upToGuests: '최대 {count}명',
    ncc: '전용차 · NCC', quote: '{count}명 총 {price}', noQuote: '이 인원은 별도 견적이 필요합니다.',
    luggage: "요금에 수하물이 포함되어 있습니다.", port: "치비타베키아 항구 출발: 총 {price}, 수하물 포함.", nccInfo: '요금표', nccContact: '호스트에게 문의하세요...', whatsapp: 'WhatsApp으로 문의하기...', close: "닫기", nccMessage: "저는 {name}입니다. 예약 번호는 {pnr}이며 도착일은 {date}입니다. NCC 전용차 이동에 대해 자세히 알고 싶습니다.", unknownDate: "날짜 확인 필요",
  ...
  ja: {
    ...
    startingPrice: '料金は{price}から', upToGuests: '{count}名まで',
    ncc: '専用車 · NCC', quote: '{count}名で合計{price}', noQuote: 'この人数の見積もりはお問い合わせください。',
    luggage: "料金には荷物も含まれています。", port: "チヴィタヴェッキア港から：合計{price}、荷物込み。", nccInfo: '料金表', nccContact: 'ホストにお問い合わせください...', whatsapp: 'WhatsAppで問い合わせる...', close: "閉じる", nccMessage: "{name}です。予約番号は{pnr}、到着日は{date}です。NCC専用車送迎について詳しく教えてください。", unknownDate: "日付未確定",
  ...
  zh: {
    ...
    startingPrice: '价格低至{price}', upToGuests: '最多{count}人',
    ncc: '私人专车 · NCC', quote: '{count}人共计{price}', noQuote: '此人数需另行询价。',
    luggage: "价格已包含行李。", port: "从奇维塔韦基亚港出发：共计{price}，含行李。", nccInfo: '价目表', nccContact: '请咨询房东...', whatsapp: '通过WhatsApp咨询...', close: "关闭", nccMessage: "我是{name}，预订编号{pnr}，到达日期为{date}。我想了解NCC私人专车接送的更多信息。", unknownDate: "日期待确认",
